...
PHP_ARG_ENABLE(screwopcode, whether to enable ScrewOpcode support,
[  --disable-screwopcode       Disable ScrewOpcode support], yes)

PHP_ARG_ENABLE(screwopcode-file, whether to enable file based caching,
[  --disable-screwopcode-file  Disable file based caching], yes, no)
...
if test "$flock_type" = "unknown"; then
	AC_MSG_ERROR([Don't know how to define struct flock on this system[,] set --enable-screwopcode=no])
fi
