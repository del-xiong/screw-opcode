...
/* VM handlers */
typedef ZEND_SCREWOPCODE_HANDLER_RET (ZEND_FASTCALL *zend_vm_opcode_handler_t)(ZEND_SCREWOPCODE_HANDLER_ARGS);

/* VM helpers */
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_leave_nested_func_helper(uint32_t call_info EXECUTE_DATA_DC);
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_leave_top_func_helper(uint32_t call_info EXECUTE_DATA_DC);
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_leave_func_helper(uint32_t call_info EXECUTE_DATA_DC);

ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_profile_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);

ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_func_counter_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_loop_counter_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);
...
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_func_trace_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_ret_trace_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);
ZEND_SCREWOPCODE_HANDLER_RET ZEND_FASTCALL zend_jit_loop_trace_helper(ZEND_SCREWOPCODE_HANDLER_ARGS);
