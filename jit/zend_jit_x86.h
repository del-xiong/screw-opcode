...
static zend_always_inline zend_jit_addr
_zend_jit_decode_op(zend_uchar
op_type,
znode_op op,
const zend_op *opline, zend_reg
reg)
{
if (op_type == IS_CONST) {
...
zend_jit_same_addr(zend_jit_addr
addr1,
zend_jit_addr addr2
)
{
